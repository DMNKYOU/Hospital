...
namespace PMI.Hospital.Business.Specifications.Search
{
    ...
    /// </summary>
    public class NotEqualDateSearchInfoSpec : Specification<PersonEntity>
    {
        /// <summary>
        ...
        public NotEqualDateSearchInfoSpec(DateTime startDate, DateTime endDate, bool asNoTracking = true)
        {
            Query
