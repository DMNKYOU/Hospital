...
{
    /// <summary>
    /// The greater or equal specification.
    /// </summary>
    public class GreaterOrEqualDateSearchInfoSpec : Specification<PersonEntity>
    {
        ...
        public GreaterOrEqualDateSearchInfoSpec(DateTime date, bool asNoTracking = true)
        {
            Query
